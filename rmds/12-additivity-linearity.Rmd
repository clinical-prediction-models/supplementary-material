# Assumptions in Regression Models - Additivity and Linearity{#ch:additivity-linearity}
...
### Plot in n=785
interact_plot(fullints2, pred = AGE, modx = HRT, outcome.scale = "link", colors=mycolors[c(4,2)], lwd=c(3,2), main.title="GUSTO-I, n=785, AGE*HRT interaction",
...
interact_plot(fullintF, pred = AGE, modx = HRT, outcome.scale = "link", colors=mycolors[c(4,2)], lwd=c(3,2), main.title="GUSTO-I, n=40,830, AGE*HRT interaction",
...
interact_plot(full8, pred = AGE, modx = HRT, outcome.scale = "link", colors=mycolors[c(4,2)], lwd=c(3,2), main.title="AGE + HRT, 2 df",
              interval=T, xlim=c(35,85), x.label="Age (years)", y.label = "Logit 30-day mortality", modx.labels=c(0,1), legend.main="HRT")
...
interact_plot(fullints4, pred = AGE, modx = HRT, data=gustos, outcome.scale = "link", colors=mycolors[c(4,2)], lwd=c(3,2), 
...
interact_plot(fullints3, pred = AGE, modx = HRT, data=gustos, outcome.scale = "link", colors=mycolors[c(4,2)], lwd=c(3,2),  
...
# Plot
val.prob.ci.2(y=gustoB[,"DAY30"], logit=lrm.val.full, riskdist="predicted", logistic.cal=F, 
...
val.prob.ci.2(y=gustoB[,"DAY30"], logit=lrm.val.full, riskdist="predicted", logistic.cal=F, smooth = "rcs", nr.knots=3, g=8, 
              xlim=c(0,.5), ylim=c(0,.5), legendloc =  c(0.18 , 0.15), statloc = c(0,.4), roundstats=3,
              xlab="Predicted probability from n=785", ylab="Observed proportion in n=20318")
title(bquote(paste("Main effects, 2", italic("df"))))

val.prob.ci.2(y=gustoB[,"DAY30"], logit=lrm.val.int1, riskdist="predicted", logistic.cal=F, smooth = "rcs", nr.knots=3, g=8, 
              xlim=c(0,.5), ylim=c(0,.5), legendloc =  c(0.18 , 0.15), statloc = c(0,.4), roundstats=3,
              xlab="Predicted probability from n=785", ylab="Observed proportion in n=20318")
title(bquote(paste("Simple AGE*HRT interaction, 3", italic("df"))))

val.prob.ci.2(y=gustoB[,"DAY30"], logit=lrm.val.int2, riskdist="predicted", logistic.cal=F, smooth = "rcs", nr.knots=3, g=8, 
              xlim=c(0,.5), ylim=c(0,.5), legendloc =  c(0.18 , 0.15), statloc = c(0,.4), roundstats=3,
              xlab="Predicted probability from n=785", ylab="Observed proportion in n=20318")
title(bquote(paste("(AGE-55)+*HRT interaction, 3", italic("df"))))

val.prob.ci.2(y=gustoB[,"DAY30"], logit=lrm.val.int3, riskdist="predicted", logistic.cal=F, smooth = "rcs", nr.knots=3, g=8, 
              xlim=c(0,.5), ylim=c(0,.5), legendloc =  c(0.18 , 0.15), statloc = c(0,.4), roundstats=3,
              xlab="Predicted probability from n=785", ylab="Observed proportion in n=20318")
